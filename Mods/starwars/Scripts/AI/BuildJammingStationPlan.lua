...
function Definitions()
	...
	{
		"StructureForce",
		"R_Orbital_Jamming_Station | E_Orbital_Jamming_Station | Empire_Golan_One | Rebel_Golan_One | Rebel_Golan_Two | Rebel_Golan_Three | Empire_Golan_Three | Empire_Golan_Two = 1"
	}
	}
