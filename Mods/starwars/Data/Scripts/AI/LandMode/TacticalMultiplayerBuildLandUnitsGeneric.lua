...
function Definitions()
	...
	TaskForce = {
	{
		...
		,"Rebel_Infiltrator_Team | RN_Rebel_Pod_Walker_Company | Rebel_Pirate_Skiff_Team | Rebel_Pirate_Swamp_Speeder_Team | Rebel_Pod_Walker_Company | Rebel_Infantry_Squad | Rebel_Tank_Buster_Squad | Rebel_Artillery_Brigade | Rebel_Light_Tank_Brigade | Rebel_Heavy_Tank_Brigade | Rebel_Medium_Tank_Brigade | Rebel_R3_Squad | Rebel_Heavy_Tank_Brigade2 | Rebel_Fast_Tank_Brigade  = 0,3"
		,"EN_Imperial_Pod_Walker_Company | Empire_Pirate_Skiff_Team | Empire_Pirate_Swamp_Speeder_Team | Imperial_Stormtrooper_Squad | Imperial_Artillery_Corp | Imperial_Anti_Infantry_Brigade | Imperial_Armor_Group | Imperial_Heavy_Scout_Squad | Imperial_Heavy_Assault_Company | Imperial_Light_Scout_Squad | DarkTrooper_P1_Company | DarkTrooper_P2_Company | DarkTrooper_P3_Company | Noghri_Assassin_Squad | Imperial_EWEB_Squad | Imperial_Light_Recon_Squad | AT-TE_Company | Imperial_Probe_Squad | Imperial_XR_85_Squad | AT_PT_Company = 0,3"
		,"Canderous_Assault_Tank_Company | Destroyer_Droid_Company | Underworld_Disruptor_Merc_Squad | MAL_Rocket_Vehicle_Company | Underworld_Merc_Squad | Night_Sister_Company | MZ8_Pulse_Cannon_Tank_Company | Underworld_Pod_Walker_Company | Underworld_Skiff_Team | Underworld_Swamp_Speeder_Team | Underworld_Mandalorian_Assault_Squad | BattleDroid_Squad | Persuader_Droid_Enforcer_Company | Underworld_Super_BattleDroid_Squad | AAT_Tank_Company Droideka_Mk1_Company | Hailfire_Tank_Company | Stap_Squad | Multi_Troop_Transport_Company = 0,3"
		,"Rebel_Speeder_Wing | Gallofree_HTT_Company | Rebel_MDU_Company | Rebel_Fighter_Wing = 0,1"
		,"HAV_Juggernaut_Company | Lancet_Air_Wing | Imperial_Anti_Aircraft_Company | Empire_MDU_Company | Laat_Air_Wing = 0,1"
		,"Vornskr_Wolf_Pack | F9TZ_Cloaking_Transport_Company | Underworld_MDU_Company | V19_Air_Wing = 0,1"
		}
	}
