...
function Definitions()
	...
	{
		"BaseForce",
		"E_Ground_Heavy_Vehicle_Factory | Empire_Kuat_Drive_Yards | Empire_Sienar_Systems | R_Ground_Heavy_Vehicle_Factory | Rebel_Kuat_Drive_Yards | Rebel_SoroSuub | CEC | Rendili_Stardrive | Moncal_Shipyards  = 1"
	}
	}
