/*
	...
	2x Diffuse+Spec lighting, alpha lighting.
...
pixelshader bump_spec_light_ps_main_bin = compile ps_2_0 bump_spec_light_ps_main();
pixelshader bump_light_ps_main_bin = compile ps_1_1 bump_light_ps_main();
...
technique max_viewport
{
    pass max_viewport_p0
    {
        ...
        PixelShader  = (bump_spec_light_ps_main_bin);
    }  
}
...
>
{
    pass sph_t1_p0
    {
        ...
        PixelShader  = (bump_light_ps_main_bin);
   		AlphaBlendEnable = (m_lightScale.w < 1.0f); 
